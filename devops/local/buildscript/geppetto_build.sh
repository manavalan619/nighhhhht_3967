...
DESKTOPCODE='../../../application/client/desktop/nighhhhht_3967'
DESKTOPIMAGENAME='geppettotest/nighhhhht_3967-desktop:1.0'
...
helm install --name nighhhhht_3967 ./helm
if [ $? -eq 0 ]; then
